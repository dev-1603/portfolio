...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <div class="animate-fade-in">
      ...
      <p class="text-xl md:text-2xl text-dark-600 dark:text-dark-300 mb-4">
        {personalInfo.title} with expertise in {personalInfo.domains.join(', ').toLowerCase()}
      </p>
      <p class="text-lg text-dark-500 dark:text-dark-400 mb-8 max-w-3xl mx-auto">
      ...
      <div class="flex flex-wrap justify-center gap-2 mb-8">
        {#each personalInfo.domains as domain}
          <span class="px-4 py-2 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-full text-sm font-medium">
            {domain}
          </span>
        {/each}
      </div>
      ...
      <div class="flex flex-col sm:flex-row gap-3 justify-center">
        <a
          ...
          class="inline-flex items-center px-6 py-3 bg-dark-100 dark:bg-dark-800 text-dark-700 dark:text-dark-300 rounded-lg hover:bg-dark-200 dark:hover:bg-dark-700 transition-colors duration-200 focus-ring"
        >
