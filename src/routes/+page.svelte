  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid lg:grid-cols-3 gap-8 items-center">
      ...
      <div class="animate-fade-in" style="animation-delay: 0.2s;">
        <div class="relative">
          <!-- Avatar Container -->
          <div class="relative mx-auto lg:mx-0 w-72 h-72 lg:w-80 lg:h-80">
            <div class="w-full h-full bg-gradient-to-br from-primary-200 via-accent-200 to-primary-300 dark:from-primary-800 dark:via-accent-800 dark:to-primary-700 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-shadow duration-300 relative overflow-hidden">
              ...
              <div class="absolute -top-2 -right-2 w-12 h-12 bg-accent-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              
              <div class="absolute -bottom-2 -left-2 w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
          ...
          <div class="flex justify-center lg:justify-start gap-4 mt-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="w-12 h-12 bg-dark-100 dark:bg-dark-800 text-dark-700 dark:text-dark-300 rounded-full flex items-center justify-center hover:bg-dark-200 dark:hover:bg-dark-700 transition-all duration-200 focus-ring transform hover:scale-110"
            >
          ...
          <div class="mt-6 space-y-3">
            <div class="bg-white dark:bg-dark-900 rounded-xl p-4 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div class="flex items-center">
                ...
                <div>
                  <div class="text-sm font-medium text-dark-900 dark:text-white">Location</div>
        ...
        {#each professionalProjects.slice(0, 3) as project, index}
          <div class="animate-scale-in" style="animation-delay: {index * 0.1}s;">
            <div class="bg-white dark:bg-dark-900 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-dark-200 dark:border-dark-700">
              <div class="h-48 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/20 dark:to-blue-800/20 flex items-center justify-center">
    ...
    <div class="mb-16">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {#each personalProjects.slice(0, 3) as project, index}
          <div class="animate-scale-in" style="animation-delay: {index * 0.1}s;">
            <div class="bg-white dark:bg-dark-900 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden border border-dark-200 dark:border-dark-700">
              <div class="h-48 bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900/20 dark:to-green-800/20 flex items-center justify-center">
                <div class="text-4xl">🚀</div>
              </div>
              <div class="p-6">
                <div class="flex items-center justify-between mb-3">
